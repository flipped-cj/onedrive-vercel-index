...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'admin@oyal.ml',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/oyal',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/oyal616',
    },
  ],
